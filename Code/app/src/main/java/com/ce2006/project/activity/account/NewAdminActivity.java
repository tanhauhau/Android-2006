...
public class NewAdminActivity extends ActionBarActivity implements View.OnClickListener {
     ...
     * check all fields to be filled and filled correctly
     * then call {@link NewAdminActivity#createAdmin()}
     *
     * @param v
     */
    @Override
    ...
    /**
     * Start AsyncTask to call {@link com.ce2006.project.server.Particulars#createAdmin(String, String, String, String)}
     */
