 ...
 */
public class DoctorAppointmentArrayAdapter extends ArrayAdapter<Appointment> {
    public DoctorAppointmentArrayAdapter(Context context, Appointment[] appointments) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtClinicName.setVisibility(View.GONE);
        return convertView;
    }
