...
/**
 * Activity that show lists of appointments and allow user to click to see details of it
 * and options to modify or delete the appointment
 */
public class ViewModifyAppointmentActivity extends ActionBarActivity implements ViewAppointmentListFragment.Listener, ModifyAppointmentFragment.Listener, FragmentManager.OnBackStackChangedListener {
    ...
    /**
     * delete the current selected appointment
     */
     ...
     * @param appointment
     * @see com.ce2006.project.activity.appointment.ViewAppointmentFragment
     */
    @Override
