...
public class Appointment implements Serializable {
    ...
    public static Appointment parseFromJson(JSONObject obj) {
        ...
        if (obj.containsKey("doctor"))
            appointment.doctor = Doctor.parseFromJson((JSONObject) obj.get("doctor"));
        if (obj.containsKey("patient"))
            appointment.patient = Patient.parseFromJson((JSONObject) obj.get("patient"));
